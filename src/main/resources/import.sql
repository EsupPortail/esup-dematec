...
values (nextval('hibernate_sequence'), NULL, NULL, 'admin', TRUE, TRUE, FALSE, FALSE, '$2a$10$KFQrNLgtWFfrTcBzz2YzxuIjHArXj2Og5asxJhTZVz5oqVW4RLNdS', 1, 0, 0);

insert into appli_version values (nextval('hibernate_sequence'), '1.9.x', 1);
